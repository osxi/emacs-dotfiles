...
;; (add-hook 'before-save-hook 'strip-whitespace-unless-sql-file) ;; removed so I don't screw up breezy console
(defun add-admin-exit ()
  (interactive)
  (insert "console.log('admin exit');\nprocess.exit();")
  (execute-kbd-macro [?\t]))
...
")
 ...
 '(magit-status-buffer-switch-function 'ignore)
 '(menu-bar-mode nil)
 '(mode-line-format
